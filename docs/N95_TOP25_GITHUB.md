...
### Harvest delta — 2026-09-21

| Run evidence | Observation |
|---|---|
| Role / flow | Black throughout: discover → verify → read → reserve/reject |
| Existing-state baseline | `01cb2442757370a32b1a560bf298d6f466b9522b`; required five governance/catalogue files plus current README, deployment blueprint and `n95_native/core_handoff.py` read first |
| Named unmet need | Make source harvesting and C1 mission/evidence constraints fail closed under untrusted repository metadata, least-privilege roles and unsupported version assumptions |
| Scope | Five prior upstreams compared from their 2026-09-14 pins; two reserve refinements, four rejected inferences; no new catalogue entry |
| Execution / admission | Capability tests NOT_RUN; independent White NOT_RUN; physical free space UNKNOWN; no target admitted, cleaned, planned for cleanup, installed, optimized, pulled or executed |
| Authority | Existing Core/PostgreSQL remains the only mission authority; GM700 control, bounded RTX worker, Surface review; C1 precedes C2–C6 |

#### Source deltas, release boundaries and decisions

Observation date: 2026-09-21 UTC. Release and branch metadata are maintenance signals, not behavior results.

| Source | Prior → observed pin | Primary material read | Category / decision |
|---|---|---|---|
| postgres/postgres | `6547a2f6cccf8cfdd91a0b278bb65f0b00bdd2` → development head [`d39fda1cc404834781458376173e5293f870e83a`](https://github.com/postgres/postgres/tree/d39fda1cc404834781458376173e5293f870e83a); 64 commits | [RI permission fix `2c45694`](https://github.com/postgres/postgres/commit/2c45694a240e89c3f7d848d433f78e394521b6d6), [RI cache invalidation `c62b330`](https://github.com/postgres/postgres/commit/c62b330912e2095dc8dee2f749adf7e5d94ca611), [code](https://github.com/postgres/postgres/blob/d39fda1cc404834781458376173e5293f870e83a/src/backend/utils/adt/ri_triggers.c), [fixture](https://github.com/postgres/postgres/blob/d39fda1cc404834781458376173e5293f870e83a/src/test/regress/sql/foreign_key.sql), [license](https://github.com/postgres/postgres/blob/d39fda1cc404834781458376173e5293f870e83a/COPYRIGHT) blob `0a397648dcd3c2177acc58bd7daecd11ad64be62` | C08 Data + C07 Security; refine R01 test, not a version selection |
| yamadashy/repomix | `6c5ead0d2b83911d4284be9f3424e7381ae44763` → [v1.18.1 `80b4280a9196feace092fc672dfe2b5fac62ef08`](https://github.com/yamadashy/repomix/tree/80b4280a9196feace092fc672dfe2b5fac62ef08); release published 2026-09-21 08:34:49 UTC and marked immutable by GitHub | [release](https://github.com/yamadashy/repomix/releases/tag/v1.18.1), [git hardening](https://github.com/yamadashy/repomix/blob/80b4280a9196feace092fc672dfe2b5fac62ef08/src/core/git/gitCommand.ts), [tests](https://github.com/yamadashy/repomix/blob/80b4280a9196feace092fc672dfe2b5fac62ef08/tests/core/git/gitCommand.test.ts), [comment handling](https://github.com/yamadashy/repomix/blob/80b4280a9196feace092fc672dfe2b5fac62ef08/src/core/file/fileManipulate.ts), [manifest](https://github.com/yamadashy/repomix/blob/80b4280a9196feace092fc672dfe2b5fac62ef08/package.json), [MIT license](https://github.com/yamadashy/repomix/blob/80b4280a9196feace092fc672dfe2b5fac62ef08/LICENSE) | C05 Tools + C07 Security; refine R04 |
| docling-project/docling | `014e8e357b24aa9d5113317fa454df8a70de9aeb` → latest release [v2.129.0 `890dd42d017497c955a56a1d2cfc3f0af5bc2aa9`](https://github.com/docling-project/docling/tree/890dd42d017497c955a56a1d2cfc3f0af5bc2aa9); branch head [`1b4092810c364e1fdc0b5d358faf353f9ca9447e`](https://github.com/docling-project/docling/tree/1b4092810c364e1fdc0b5d358faf353f9ca9447e) is 44 commits after the prior pin | Post-tag [optional `docling_parse` import guard](https://github.com/docling-project/docling/commit/1b4092810c364e1fdc0b5d358faf353f9ca9447e), [v2.129.0 manifest](https://github.com/docling-project/docling/blob/890dd42d017497c955a56a1d2cfc3f0af5bc2aa9/packages/docling/pyproject.toml), [MIT license](https://github.com/docling-project/docling/blob/1b4092810c364e1fdc0b5d358faf353f9ca9447e/LICENSE) | C08 Data + C05 Tools; reject inference that v2.129.0 contains the later guard; R05 unchanged |
| ollama/ollama | `53fed26112817f7c55f664efb9e3f65f06cab7db` → latest release [v0.34.2 `dfabde4539e42ba1e1eab50a3a50b88aea7958a0`](https://github.com/ollama/ollama/tree/dfabde4539e42ba1e1eab50a3a50b88aea7958a0); branch head [`6383a0fa9cbf97494b847226e189f6e36b401a08`](https://github.com/ollama/ollama/tree/6383a0fa9cbf97494b847226e189f6e36b401a08) is 29 commits after the prior pin | [redirect validation](https://github.com/ollama/ollama/blob/dfabde4539e42ba1e1eab50a3a50b88aea7958a0/x/transfer/redirect.go), [tests](https://github.com/ollama/ollama/blob/dfabde4539e42ba1e1eab50a3a50b88aea7958a0/x/transfer/redirect_test.go), post-release [allowlist change](https://github.com/ollama/ollama/commit/6383a0fa9cbf97494b847226e189f6e36b401a08), [MIT runtime license](https://github.com/ollama/ollama/blob/dfabde4539e42ba1e1eab50a3a50b88aea7958a0/LICENSE) | C02 Inference + C07 Security; reject promotion: no existing adapter, target admission or model-license/result evidence |
| modelcontextprotocol/python-sdk | selected v2 pin remains [v2.2.0 `9972c21aa42054fb1450c5fc614761ed11847ec6`](https://github.com/modelcontextprotocol/python-sdk/tree/9972c21aa42054fb1450c5fc614761ed11847ec6); branch head [`6affe5c0d3588fd1705713b3703dc68015cfe3eb`](https://github.com/modelcontextprotocol/python-sdk/tree/6affe5c0d3588fd1705713b3703dc68015cfe3eb) is one later commit | Post-tag [Windows command-resolution cancellation change](https://github.com/modelcontextprotocol/python-sdk/commit/6affe5c0d3588fd1705713b3703dc68015cfe3eb), [v2 manifest](https://github.com/modelcontextprotocol/python-sdk/blob/9972c21aa42054fb1450c5fc614761ed11847ec6/pyproject.toml), [MIT license](https://github.com/modelcontextprotocol/python-sdk/blob/9972c21aa42054fb1450c5fc614761ed11847ec6/LICENSE) | C05 Tools + C04 Automation; reject inference that v2.2.0 contains the later fix; v2 examples only |

#### Reserve refinements

| ID | Facts read / claim boundary | Input → transform → output pattern | Existing architecture mapping | Dependencies, permissions and failure paths | Bounded pass/fail test |
|---|---|---|---|---|---|
| R01 refinement | PostgreSQL development commits add RI fast-path permission parity and invalidate cached fast-path metadata after operator-family changes. Upstream tests exist; no local or selected-release result exists. Both messages state backpatch-through 19, but inclusion in the eventual supported package is UNKNOWN | Mission/evidence row + referenced keys + deployment role/grant matrix → permission evaluation, FK fast path or SPI fallback, cache invalidation → valid reference committed OR missing reference/insufficient permission rejected without partial mission state | Existing Core mission/state authority on GM700; current concrete seam is `n95_native/core_handoff.py::validate_with_core`, which references external `src/n95_ops/engine.py`. Storage implementation/version remains missing. C1 before R06/C2 and C3–C6 | Supported PostgreSQL release, exact schema owner/application identities, restricted credentials, FK/index definitions. Elevated operator-family DDL is fixture-only. PostgreSQL license notices retained. Permission error, stale metadata, bad reference and rollback are explicit failure paths | NOT_RUN. In a disposable database on the selected version, exercise allowed and denied role matrices plus valid/invalid evidence references; pass only if valid rows commit, every invalid/unauthorized write fails, and no orphan/partial mission or evidence row remains |
| R04 refinement | Repomix v1.18.1 code passes `-c core.fsmonitor=`, `--no-show-signature`, `--no-ext-diff` and `--no-textconv` to relevant local Git reads. Its tests include real malicious-repository negative cases on POSIX and exact-argument checks; none ran here. The same release adds shell/YAML-aware comment removal. Release immutability and test presence do not establish runtime behavior | Pinned public source tree, inclusion list and optional transforms → ordinary full-file reads; if Git metadata is consulted, neutralize executable repository config; preserve shell parameter expansions, heredocs and YAML block scalars → source pack + original file locators OR explicit failure, never execution evidence | Existing Black repository-reader stage under `docs/REPO_EXTRACTION_PROTOCOL.md`; any resulting observation can enter only as a digest-bound draft through `n95_native/core_handoff.py::prepare`. No extractor runtime module or authority added. GM700 research/control role; C4 after C1–C3, supporting C05/C07 | Repomix 1.18.1 requires Node >=22; Git subprocess and local filesystem read permissions; MIT notices; dependencies/transitive terms still require review. Crafted `.git/config`, malformed paths, transform corruption and incomplete compression are failure paths. Structural compression still cannot replace full behavior review | NOT_RUN. Use one disposable public fixture containing inert marker commands in repository config plus shell/YAML edge cases. Pass only if no marker executes, packed shell/YAML semantics match original fixed assertions, all five R04 source questions cite original pinned files, and full sources remain available for behavior review |

#### Rejections and reopening conditions

| ID | Inference | Decision / reopening evidence |
|---|---|---|
| X11 | A read-only source pack cannot execute repository-controlled behavior | reject. Git history/diff inspection can honor executable repository configuration. Reopen tool admission only after the R04 malicious-config test passes on the exact selected artifact; generic green CI is insufficient |
| X12 | Docling v2.129.0 includes the deferred optional `docling_parse` import guard | reject. Tag `890dd42d017497c955a56a1d2cfc3f0af5bc2aa9` predates commit `1b4092810c364e1fdc0b5d358faf353f9ca9447e`. Reopen when a chosen tagged release contains it, then construct `DocumentConverter` without the PDF extra and require non-PDF construction plus an explicit install-hint failure only when that PDF backend is selected. Parser/model/OCR extras remain separate |
| X13 | MCP v2.2.0 contains the Windows event-loop cancellation change | reject. The selected v2.2.0 tag remains `9972c21aa42054fb1450c5fc614761ed11847ec6`; commit `6affe5c0d3588fd1705713b3703dc68015cfe3eb` is later development source. Reopen at an exact compatible v2 release, then bound cancellation and stream cleanup. No v1 example is admitted |
| X14 | Ollama redirect hardening or an allowlisted redirect proves an admitted/working RTX model path | reject. v0.34.2 validates schemes/addresses and its later branch follow-up changes cross-host policy, but no existing stack adapter, physical free-space result, driver/model fit, scoped credential, model-license review, pull or embedding result exists. Reopen only after >=200 GB target admission, an exact released runtime/model pin and authorized R03 execution; results remain NOT_RUN until then |

| Preserved control | Status |
|---|---|
| Core/PostgreSQL mission authority | unchanged |
| GM700 / RTX / Surface roles | unchanged |
| R01 → R06/C2 → R03/C3 → C4/C5 → C6 dependency order | unchanged |
| Repomix full-source behavior review requirement | unchanged |
| Docling parser/model/OCR separation | unchanged |
| MCP version-specific examples | v2.2.0 only; no v1 mixing |
| White acceptance / Green learning | absent; no self-attestation or promotion |
